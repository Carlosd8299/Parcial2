        ...
        switch (v.getId()){
            ...
            case R.id.Btnregistrar:
                if(nom.getText().toString().equals("")|| cod.getText().toString().equals("")|| salario.getText().toString().equals("")){
                    ...
                    persona = new Persona(nom.getText().toString(),nivelEdu,estrato,cod.getText().toString(), Double.parseDouble(salario.getText().toString()));
                    ...
                    if(!c.buscarPersona(persona.cedula)) {
                        ...
                        Toast.makeText(getApplicationContext(),"Persona ya esta registrada",Toast.LENGTH_SHORT).show();
                    }
                }
                break;

...
public class PersonaCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String cod=  " Identificacion " + cursor.getString(cursor.getColumnIndexOrThrow("codigo"));
        String estrato=  " Estrato " +cursor.getString(cursor.getColumnIndexOrThrow(DefDB.col_estrato));
        String salario= " Salario devengado " +cursor.getString(cursor.getColumnIndexOrThrow(DefDB.col_salario)) ;
        String nivelE = " Nivel Educativo "+cursor.getString(cursor.getColumnIndexOrThrow(DefDB.col_nivelEducativo));
